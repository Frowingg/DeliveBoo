<template>
    <div>
        <CarouselComponent />
        <div class="d-flex" v-if="filtered_category_user.lenght === 0">
            <div style="border: 1px solid black; cursor: pointer" v-for="category in categories"  :key="category.id" @click="showThisCategoryUser(category.name)">
                <h6>{{ category.name }}</h6>
