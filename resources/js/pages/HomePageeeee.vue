<template>
    <div>
        ...
        <div class="contain">
            <a class="card" href="" v-for="filteredUser in filtered_category_user" :key="filteredUser.id">
                <!-- <img src="" alt=""> -->
...
import ButtonCategories from "../components/MainPages/ButtonCategories.vue";
